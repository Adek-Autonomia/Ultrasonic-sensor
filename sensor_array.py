...
class SonarArray():
    ...
    def scan(self):
        """
        the core of sonar, it initializes 3 US sensors and gets distance from them
        ...
        Returns
        -------
        fills the range_array table with distance values for each sonar
        """
        range_array = []
